...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      ...
      } flex flex-col justify-between border border-gray-200 bg-white cursor-pointer
       transition-all duration-300 min-w-[223px] max-w-[223px] min-h-[283px] max-h-[283px]`}
    >
      <div className="relative">
        <div
          className="absolute top-0 left-0 bg-green-700 text-white font-bold 
        w-[43px] h-[47px]"
        >
      ...
      <div
        className={`${
          hovered ? "bg-orange-600 shadow-lg" : "bg-gray-300"
        } h-[33px] flex bg-gray-700 text-center items-center`}
      >
        <button className="w-full bottom-0 text-sm text-white font-medium transition-all duration-300">
          View Details
        </button>
      </div>
    </div>
